...
email = "sammathur4@gmail.com"
password = "qwertyjkl123"
...
keywords = ["backend", "python", "programming"]
...
# salary - ex:["$40,000+", "$60,000+", "$80,000+",
# "$100,000+", "$120,000+", "$140,000+", "$160,000+", "$180,000+", "$200,000+" ] - select only one
salary = ["$80,000+"]
