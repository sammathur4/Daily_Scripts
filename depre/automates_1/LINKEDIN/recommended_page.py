...
class LinkedinBot:
    ...
    def __init__(self):
        ...
        self.driver.get("https://www.linkedin.com/jobs/collections/recommended?f_AL=true")
        sleep(2)
    ...
    def click_easy_jobs(self):
        ...
        while 1:
            ...
            while j < total_jobs:
                ...
                try:
                    print()
                    print(left_panel_jobs[j])
                    sleep(30)
                    job_name_element = left_panel_jobs[j].find_element(
                        by=By.CSS_SELECTOR,
                        value=".job-details-jobs-unified-top-card__container--two-pane .job-details-jobs-unified-top-card__content--two-pane",
                    )
