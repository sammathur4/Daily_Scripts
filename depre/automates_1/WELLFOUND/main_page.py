...
class WellFound:
    ...
    def __init__(self, company_name):
        ...
        self.driver.get(f"https://www.wellfound.com/jobs/")
        sleep(10)
        ...
        while 1:
            ...
            try:
                self.driver.execute_script(
                    "window.scrollTo(0, arguments[0].offsetTop);",
                    visible_connect_buttons[j],
                )
                ...
                self.driver.find_element(
                    by=By.XPATH,
                    value="//button[@class='artdeco-modal__dismiss artdeco-button artdeco-button--circle artdeco-button--muted artdeco-button--2 artdeco-button--tertiary ember-view']",
                ).click()
